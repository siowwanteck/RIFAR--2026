...
export function resetSimulation() {
  ...
  undoableActionSnapshots = new Map();
...
export function undoRecommendedAction(actionId) {
  const snapshot = undoableActionSnapshots.get(actionId);
  ...
  undoableActionSnapshots.delete(actionId);
